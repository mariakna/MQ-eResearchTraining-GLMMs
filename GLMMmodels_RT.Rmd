...
(Accuracy <- summarySEwithin(sum, measurevar = "Acc", withinvars = "Cond",
...
(RT <- summarySEwithin(sum2, measurevar = "meanRT", withinvars = "Cond",
                       idvar = "Subj", na.rm = FALSE, conf.interval = .95))
```
...
RT2 <- summarySEwithin(sum3, measurevar = "meanRT", withinvars = "Cond",
                       idvar = "Subj", na.rm = FALSE, conf.interval = .95)

ggplot(RT2, aes(x = Cond, y = meanRT, fill = Cond)) +
  geom_bar(position = position_dodge(), stat = "identity",
           color = "black",
           size = .3) +
  geom_errorbar(aes(ymin = meanRT-se, ymax = meanRT+se),
...
RT1 <- summarySEwithin(sum4, measurevar = "meanRT", withinvars = "Cond",
                       idvar = "Subj", na.rm = FALSE, conf.interval = .95)

ggplot(RT1, aes(x = Cond, y = meanRT, fill = Cond)) +
  geom_bar(position = position_dodge(), stat = "identity",
           color = "black", 
           size = .3) +
  geom_errorbar(aes(ymin = meanRT-se, ymax = meanRT+se),
