---
title: "Analysis of RT data using (generalised) linear mixed effects models in R"
...
>>>>>>> d0edc6a5accb44f32d2bf46e5d908ac81b7845e9
...
We can compare whether a model without a predictor is better than a model with a predictor:
...
Is this model better than a model without predictors?
